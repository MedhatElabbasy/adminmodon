...
export class BusinessTypeService {
  ...
  getAllBusinessType() {
    return this.http.get<Lookup[]>(this.url + `api/BusinessType/GetAll`).pipe(
      tap((res) => {
        this.lookups = [...res];
  ...
  add(model: Lookup) {
    this.http
      .post<Lookup>(this.url + `api/BusinessType/Add`, model)
      .subscribe((response) => {
  ...
  update(model: Lookup) {
    this.http
      .post<Lookup>(this.url + `api/BusinessType/Update`, model)
      .subscribe((response) => {
  ...
  delete(id: any) {
    this.http
      .post<Lookup>(this.url + `api/BusinessType/Delete?id=${id}`, null)
      .subscribe((response) => {
        if (response) {
          if (response) {
