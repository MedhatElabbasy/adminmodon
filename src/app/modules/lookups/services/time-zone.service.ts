...
export class TimeZoneService {
  ...
  getAllTimeZones() {
    return this.http.get<Lookup[]>(this.url + `api/TimeZoneLookup/GetAll`).pipe(
      tap((res) => {
        this.lookups = [...res];
  ...
  add(model: Lookup) {
    this.http
      .post<Lookup>(this.url + `api/TimeZoneLookup/Add`, model)
      .subscribe((response) => {
  ...
  update(model: Lookup) {
    this.http
      .post<Lookup>(this.url + `api/TimeZoneLookup/Update`, model)
      .subscribe((response) => {
  ...
  delete(id: any) {
    this.http
      .post<Lookup>(this.url + `api/TimeZoneLookup/Delete?id=${id}`, null)
      .subscribe((response) => {
        if (response) {
          if (response) {
